...
#define VERSION 75
#define VERSIONSTRING "omega version 0.75 (beta)"
...
struct location {
  ...
  uchar lstatus; /* seen,stopsrun,lit,secret, */
  ...
  uchar buildaux; /* used in constructing level */
...
#include <stdio.h>
#else
/* Include stdio.h only if not already include (by curses.h) */
#ifndef NULL
#include <stdio.h>
#endif
#endif
