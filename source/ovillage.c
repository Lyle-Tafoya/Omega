...
#else
  case 1:strcat(Str3,"ovillag1.dat");break;
  case 2:strcat(Str3,"ovillag2.dat");break;
  case 3:strcat(Str3,"ovillag3.dat");break;
  case 4:strcat(Str3,"ovillag4.dat");break;
  case 5:strcat(Str3,"ovillag5.dat");break;
  case 6:strcat(Str3,"ovillag6.dat");break;
#endif
  }
  fd = fopen(Str3,"r");
  for(j=0;j<LENGTH;j++) {
