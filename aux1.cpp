...
void calc_melee() {
  ...
  if (Player.possessions[O_WEAPON_HAND] != NULL)
    if (Player.possessions[O_WEAPON_HAND]->used &&
      ...
      Player.hit += Player.possessions[O_WEAPON_HAND]->hit +
                    Player.possessions[O_WEAPON_HAND]->plus;
      Player.dmg += Player.possessions[O_WEAPON_HAND]->dmg +
                    Player.possessions[O_WEAPON_HAND]->plus;
    }
  ...
  if (Player.possessions[O_SHIELD] != NULL) {
    Player.defense +=
        Player.possessions[O_SHIELD]->aux + Player.possessions[O_SHIELD]->plus;
  }
...
void roomcheck() {
  ...
  if ((roomno == RS_CAVERN) || (roomno == RS_SEWER_DUCT) ||
...
void threaten(struct monster *m) {
  ...
  else if ((m->talkf != M_TALK_GREEDY) && (m->talkf != M_TALK_HUNGRY) &&
           (m->talkf != M_TALK_EVIL) && (m->talkf != M_TALK_MAN) &&
           (m->talkf != M_TALK_BEG) && (m->talkf != M_TALK_THIEF) &&
