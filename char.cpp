...
long calcmana() { return (Player.pow * (long)(Player.level + 1)); }
...
void user_character_stats() {
  int num, iqpts = 0, numints = 0, ok, agipts = 0, dexpts = 0, powpts = 0,
           conpts = 0;
...
void omegan_character_stats() {
  ...
  do {
    ...
    Player.cash = random_range(100) + random_range(100) + random_range(100) +
                  random_range(100) + random_range(100);
    calc_melee();
    dataprint();
