...
void        p_drown(void);
void        p_fumble(int);
void        p_hit(struct monster *, int, damage_type);
void        p_win(void);
...
void acquire(int);
void ball(int, int, int, int, int, damage_type);
void bless(int);
void bolt(int, int, int, int, int, int, damage_type);
void enchant(int);
...
void        m_damage(struct monster *, int, damage_type);
