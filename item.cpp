...
pob create_object(int itemlevel)
{
  ...
  while (! ok) {
    ...
    r= random_range(135);
    if (r < 20) make_thing(o,-1);
    else if (r < 40) make_food(o,-1);
    else if (r < 50) make_scroll(o,-1);
    else if (r < 60) make_potion(o,-1);
    else if (r < 70) make_weapon(o,-1);
    else if (r < 80) make_armor(o,-1);
    else if (r < 90) make_shield(o,-1);
    else if (r < 100) make_stick(o,-1);
    else if (r < 110) make_boots(o,-1);
    else if (r < 120) make_cloak(o,-1);
    else if (r < 130) make_ring(o,-1);
    else make_artifact(o,-1);
...
void make_ring(pob o, int id)
{
  ...
  *o = Objects[RINGID+id];
  if (o->blessing == 0) o->blessing = itemblessing();
  if (o->plus == 0) o->plus = itemplus()+1;
  if (o->blessing < 0) o->plus = -1 - abs(o->plus);
}
